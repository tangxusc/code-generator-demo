...
import (
	...
	v1 "../crd/storeset/v1"
	"github.com/stream-stack/common/crd/generated/clientset/versioned/scheme"
...
// CoreV1Client is used to interact with features provided by the core.stream-stack.tanx group.
type CoreV1Client struct {
	restClient rest.Interface
}

func (c *CoreV1Client) StoreSets(namespace string) StoreSetInterface {
	return newStoreSets(c, namespace)
}
